...
export const Chat = ({ isDarkMode }: ChatProp) => {
  ...
  return (
    <div>
      <div
        className={`${styles.chatHistory} ${isDarkMode ? styles.darkModeBackground : styles.defaultModeBackground}`}
          ...
          >
            <div
              className={`${styles.messageBubble} ${
                isDarkMode ? styles.messageBubbleDarkMode : styles.messageBubbleDefault
              }`}
            >
      ...
      <div className={styles.inputWrapper}>
        <div>
          <input
            ...
            className={`${styles.input} ${isDarkMode ? styles.darkModeBackground : styles.defaultModeBackground}`}
            ref={inputRef}
          />
